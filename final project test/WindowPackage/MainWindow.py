...
class MainWindow:
	...
	def __init__(self, master):
		self.master = master
		self.frame = ttk.Frame(self.master, padding="3 2 200 200")
		...
		self.button5 = ttk.Button(self.frame, text = "Abuot", width = 25, command = lambda:\
	...
	def new_window4(self):
		self.newWindow = Toplevel(self.master)
		self.app = SS.SingleStock(self.newWindow)
